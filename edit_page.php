...
// nav bar
$data["nav_bt"]=$blade->make('page/nav_bt_edit_page',[ 'data' => $page_data , 'host' => $phost , 'sw' => $sta["sw"] ]  )->render();
...
$data["main"]=$blade->make('page/list_of_links',[ 'data' => $list,'host' => $phost] )->render();
