...
// nav bar
$data["nav_bt"]=$blade->make('cat/nav_bt_edit_cat',[ 'data' => $cat_data , 'host' => $phost , 'sw' => $sta["sw"] ]  )->render();
...
$data["main"]=$blade->make('cat/list_of_pages',[ 'data' => $list,'host' => $phost] )->render();
