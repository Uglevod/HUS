  <div class="card border-secondary m-3  ">
        <div class="card-header justify-content-center">
          ...
          <span class="badge badge-secondary ">{{ $line['count'] }}</span>
            <a href="{{ $host }}/edit/link/{{ $line['ptok'] }}/{{ $line['id'] }}" target="_blank" type="button" class="btn btn-secondary  ml-2  ">
        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item">
            ...
            <div>
              <a id="f{{ $line['id'] }}" href="{{ $line['furl'] }} " target="_blank" class="text-muted"> {{ $line['furl'] }} </a>
            </div>
          </li>
          <li class="list-group-item">
            <div class="float-right">
            ...
            <a id="s{{ $line['id'] }}" href="{{ $host }}/{{ $line['surl'] }}" target="_blank" class="text-muted"> {{ $host }}/{{ $line['surl'] }} </a>
          </li>
