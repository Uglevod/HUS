...
@if ( $sw == 1)
<a href="{{ $host }}/edit/page/{{ $data["ptok"] }}/0"   type="button" class="btn btn-outline-info m-1">Показать выключенные ссылки</a>
@elseif ( $sw == 0)
<a href="{{ $host }}/edit/page/{{ $data["ptok"] }}/1"   type="button" class="btn btn-outline-info m-1">Показать включенные ссылки</a>
@endif
